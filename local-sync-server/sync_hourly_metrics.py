...
EXPECTED_SCHEMA_SERVER = {
    ...
    'required': ['occupancy_threshold', 'average_occupancy', 'max_occupancy', 'hours']
}
...
if __name__ == '__main__':
    ...
    To test a bad date example: ?date=OOPS (400 status code error)
    ...
    """
    live_url = f'http://localhost:8300/metrics/areas/occupancy/hourly?date={datetime.now().strftime("%Y-%m-%d")}'
